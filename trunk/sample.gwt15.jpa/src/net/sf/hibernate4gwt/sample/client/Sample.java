package net.sf.hibernate4gwt.sample.client;

import net.sf.hibernate4gwt.sample.client.configuration.ConfigurationRemote;
import net.sf.hibernate4gwt.sample.client.core.Action;
import net.sf.hibernate4gwt.sample.client.core.ApplicationParameters;
import net.sf.hibernate4gwt.sample.client.core.DefaultCallback;
import net.sf.hibernate4gwt.sample.client.login.LoginPanel;
import net.sf.hibernate4gwt.sample.client.message.MessageBoard;
import net.sf.hibernate4gwt.sample.client.message.NewMessagePanel;
import net.sf.hibernate4gwt.sample.client.ui.PanelPrincipal;
import net.sf.hibernate4gwt.sample.client.user.HeaderPanel;
...
public class Sample implements EntryPoint, HistoryListener
{
	...
	private PanelPrincipal applicationPanel;
	...
	private void createMainPanel()
	{
		...
		// title
		HTML title = new HTML("<H1>Hibernate4GWT sample application</H1>(GWT1.5 / JPA stateless mode)");
		...
		// Footer
		Label footer = new Label("(c) 2007 - 2008 | http://hibernate4gwt.sourceforge.net");
	...
	// 	Create panels
		applicationPanel = new PanelPrincipal();
...
//		applicationPanel.getCellFormatter().setHorizontalAlignment(row, 0, HasHorizontalAlignment.ALIGN_LEFT);
		...
		mainPanel.add(applicationPanel.getPanel(), DockPanel.CENTER);
